...
# 🎮 Exark — Community Edition

**Exark standalone Community Edition — complete dark fantasy action RPG, ready to play.**
...
Exark is an action role-playing game set in a fractured dark fantasy world, combining skill-based melee combat, exploration, and character progression. This Community Edition is a standalone build packaged for offline play. It is fully self-contained and requires no storefront or additional software. All released content is included in this package.

Players who want a complete, offline, standalone version of Exark for Windows PC.
...
<table>
 <tr>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/3435610/9c2fcc5c320823ab69aa3a7f09c177b6bb507101/ss_9c2fcc5c320823ab69aa3a7f09c177b6bb507101.1920x1080.jpg?t=1787756595" alt="Screenshot 1" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/3435610/c6e85f6578c71215e84fa276b101a4702dad609e/ss_c6e85f6578c71215e84fa276b101a4702dad609e.1920x1080.jpg?t=1787756595" alt="Screenshot 2" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/3435610/0b070ad581760ce94649286b00853bc7ebea3cc1/ss_0b070ad581760ce94649286b00853bc7ebea3cc1.1920x1080.jpg?t=1787756595" alt="Screenshot 3" width="100%"></td>
 </tr>
</table>
...
- ⚔️ **Skill-Based Combat** — Fast-paced melee and ranged combat with dodge, parry, and combo systems.
- 🗺️ **Interconnected World** — Explore a hand-crafted realm of ruins, forests, and underground citadels.
- 🧙 **Deep Progression** — Level up attributes, enable abilities, and shape a distinct playstyle.
- 🔨 **Crafting and Loot** — Gather materials, forge weapons, and upgrade armor across rarity tiers.
- 👹 **Challenging Bosses** — Large-scale encounters with multi-phase attack patterns.
- 🎮 **Gamepad Support** — Full controller support alongside keyboard and mouse.
- 🖼️ **Graphics Options** — Scalable settings with support for high resolutions and refresh rates.
- 🌐 **Multiplayer Modes** — LAN and direct connection supported for cooperative and versus play.
- 📦 **Self-Contained Package** — Single offline build with no storefront or external dependencies.
- 🌍 **Localized Interface** — Interface text available in multiple languages.

- **Compression:** Lossless
- **Install Time:** ~5 minutes on SSD, ~12 minutes on HDD
- **Recoding:** none
- **Selective Download:** Optional bonus content and soundtrack pack can be skipped during installation
...
| **RAM** | 8 GB | 16 GB |
| **Graphics** | NVIDIA GeForce GTX 1050 Ti or AMD Radeon RX 570 (4 GB VRAM) | NVIDIA GeForce RTX 2060 or AMD Radeon RX 5600 XT (6 GB VRAM) |
| **Storage** | 25 GB available space | 25 GB on an SSD |
| **Additional** | DirectX 11 compatible sound card | DirectX 12, SSD storage for faster load times |
...
> 💡 **Saves location:** `%LOCALAPPDATA%\Exark\Saved`
